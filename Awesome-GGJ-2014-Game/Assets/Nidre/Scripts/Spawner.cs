...
public class Spawner : MonoBehaviour
{
    ...
    void Spawn()
    {
        ...
        for (int i = 0; i < 5; i++)
        {
            ...
            nt.SpawnNewEnemy(goList[goList.Count - 1].transform.position, goList[goList.Count - 1].GetComponent<uberAwesomeMogaMecha>().id, (int)uberAwesomeMogaMecha.GetComponent<uberAwesomeMogaMecha>()._style);
        }
    }
